...
export default function AdminNewsDetailPage() {
  ...
  return (
    <div className="admin-page max-w-5xl">
      ...
      <SeoDiscoverySection value={seo} onChange={setSEO} contentTitle={title || news.title} contentSummary={excerpt || news.excerpt || ""} contentBody={body || news.body || ""} routePrefix="/news/" disabled={!canEditSEO} />
