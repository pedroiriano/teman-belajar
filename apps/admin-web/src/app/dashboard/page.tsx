...
export default async function AdminDashboard() {
  ...
  return <div className="admin-page space-y-7">
    ...
    <div className="grid gap-5 xl:grid-cols-[1.35fr_1fr]">
      <section className="relative min-h-64 overflow-hidden rounded-2xl bg-gradient-to-br from-sky-600 via-sky-500 to-amber-400 p-7 text-white shadow-xl shadow-sky-950/10 sm:p-8" aria-labelledby="welcome-title"><div className="absolute -right-12 -top-16 h-64 w-64 rounded-full border-[36px] border-white/10" aria-hidden="true" /><div className="relative max-w-xl"><p className="text-xs font-black uppercase tracking-[.2em] text-sky-100">Teman Belajar Admin</p><h2 id="welcome-title" className="mt-4 text-3xl font-black sm:text-4xl">Kelola konten dengan alur yang jelas.</h2><p className="mt-4 max-w-lg text-sm leading-7 text-sky-50">Mulai dari draft, review bersama, lalu terbitkan pengalaman belajar yang berkualitas.</p><Link href="/dashboard/knowledge/create" className="mt-7 inline-flex min-h-11 items-center rounded-xl border border-white/40 bg-white/15 px-5 text-sm font-bold text-white transition hover:bg-white/25">Buat artikel baru <AdminIcon name="arrow" className="ml-2 h-4 w-4" /></Link></div></section>
