  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-[1.05fr_.95fr]">
      <section className="relative hidden overflow-hidden bg-[#111827] p-12 text-white lg:flex lg:flex-col lg:justify-between">
        <div
          className="absolute inset-0 opacity-40 [background-image:radial-gradient(circle_at_15%_20%,#0ea5e9_0,transparent_28%),radial-gradient(circle_at_85%_80%,#3b82f6_0,transparent_26%)]"
          aria-hidden="true"
        />
        ...
        <div className="relative max-w-xl">
          <p className="text-xs font-black uppercase tracking-[.22em] text-sky-300">Editorial workspace</p>
