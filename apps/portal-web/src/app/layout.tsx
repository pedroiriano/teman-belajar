          ...
          <div className="portal-container flex h-[72px] items-center justify-between gap-5">
            ...
            <div className="ml-auto flex items-center gap-2 lg:ml-0">
              ...
              <div className="hidden items-center gap-3 sm:flex">
                {session ? <><Link href="/my-learning" className="text-sm font-bold text-slate-700 hover:text-teal-700">Pembelajaran Saya</Link><a href="/api/auth/federated-logout" className="portal-button-secondary">Keluar</a></> : <Link href="/api/auth/signin" className="portal-button-primary">Masuk ke akun</Link>}
              </div>
