          ...
          <div className="portal-container flex h-[72px] items-center justify-between gap-5">
            ...
            <div className="ml-auto flex items-center gap-2 lg:ml-0">
              ...
              <div className="hidden items-center gap-3 sm:flex">
                {session ? <><Link href="/my-learning" className="text-sm font-bold text-slate-700 hover:text-teal-700">Pembelajaran Saya</Link>{/* eslint-disable-next-line @next/next/no-html-link-for-pages */}<a href="/api/auth/federated-logout" className="portal-button-secondary">Keluar</a></> : <Link href="/api/auth/signin" className="portal-button-primary">Masuk ke akun</Link>}
              </div>
              <details className="relative lg:hidden">
                ...
                <div className="portal-mobile-menu absolute right-0 top-14 w-72 rounded-2xl border p-3 shadow-2xl">
                  ...
                  <div className="mt-2 border-t border-slate-100 pt-3">{session ? <div className="grid gap-2"><Link href="/my-learning" className="portal-button-secondary">Pembelajaran Saya</Link><a href="/api/auth/federated-logout" className="portal-button-primary">Keluar</a></div> : <Link href="/api/auth/signin" className="portal-button-primary w-full">Masuk ke akun</Link>}</div>
                </div>
              </details>
            </div>
          </div>
