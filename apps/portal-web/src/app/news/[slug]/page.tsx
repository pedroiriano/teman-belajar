        ...
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <div className="text-indigo-100 flex items-center justify-center space-x-4">
            <div className="flex items-center">
              ...
              <span>{new Date(news.published_at).toLocaleDateString('id-ID', { year: 'numeric', month: 'long', day: 'numeric' })}</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 -mt-10">
        <div className="bg-white rounded-2xl shadow-xl max-w-4xl mx-auto p-8 md:p-12 border border-gray-100">
          <div className="mb-8 border-b border-gray-100 pb-8">
             <Link href="/news" className="text-indigo-600 hover:text-indigo-700 font-medium inline-flex items-center transition-colors">
