...
export const safePlatformFallback: PublicPlatformConfiguration = {
  ...
  navigation: [{ label: "Pelatihan Penuh", description: "Program terstruktur melalui Moodle.", href: "/training-programs", visible: true }, { label: "Pembelajaran Singkat", description: "Materi editorial 3–15 menit.", href: "/microlearning", visible: true }, { label: "Jalur Belajar", description: "Rangkaian kompetensi yang terarah.", href: "/learning-paths", visible: true }, { label: "Galeri Media", description: "Foto dan video terkurasi.", href: "/media-gallery", visible: true }, { label: "Pusat Pengetahuan", description: "Panduan terkurasi.", href: "/knowledge", visible: true }],
