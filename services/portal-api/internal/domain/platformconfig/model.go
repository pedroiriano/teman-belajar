...
func Validate(config Config, externalHosts []string) error {
	...
	allowedFeatures := map[string]bool{"training_programs": true, "microlearning": true, "knowledge": true, "news": true, "announcements": true, "faq": true, "search": true}
...
func validateHref(raw string, hosts map[string]bool) bool {
	...
	allowed := []string{"/", "/my-learning", "/training-programs", "/microlearning", "/knowledge", "/search", "/news", "/announcements", "/help", "/categories", "/tags"}
...
func Default() Config {
	...
	return Config{
		...
		Navigation: []NavigationItem{{Label: "Pelatihan Penuh", Description: "Program terstruktur melalui Moodle.", Href: "/training-programs", Visible: true}, {Label: "Pembelajaran Singkat", Description: "Materi editorial 3–15 menit.", Href: "/microlearning", Visible: true}, {Label: "Pusat Pengetahuan", Description: "Panduan terkurasi.", Href: "/knowledge", Visible: true}},
		...
		Features: []FeaturePresentation{{Key: "training_programs", Label: "Pelatihan Penuh", Visible: true}, {Key: "microlearning", Label: "Pembelajaran Singkat", Visible: true}, {Key: "knowledge", Label: "Pusat Pengetahuan", Visible: true}, {Key: "faq", Label: "FAQ", Visible: true}},
	}
}
