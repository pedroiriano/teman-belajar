...
func (m *mockRepo) ListPublicNews(ctx context.Context, page, pageSize int) ([]cms.News, int, error)    { return nil, 0, nil }
func (m *mockRepo) ListAdminNews(ctx context.Context, page, pageSize int) ([]cms.News, int, error)     { return nil, 0, nil }
func (m *mockRepo) GetNewsBySlug(ctx context.Context, slug string) (*cms.News, error)                  { return nil, nil }
func (m *mockRepo) CreateAnnouncement(ctx context.Context, a *cms.Announcement) error                  { return nil }
func (m *mockRepo) GetAnnouncementByID(ctx context.Context, id string) (*cms.Announcement, error)      { return nil, nil }
func (m *mockRepo) GetAnnouncementBySlug(ctx context.Context, slug string) (*cms.Announcement, error)  { return nil, nil }
func (m *mockRepo) UpdateAnnouncement(ctx context.Context, a *cms.Announcement) error                  { return nil }
func (m *mockRepo) ListActiveAnnouncements(ctx context.Context) ([]cms.Announcement, error)            { return nil, nil }
func (m *mockRepo) ListAdminAnnouncements(ctx context.Context, p, ps int) ([]cms.Announcement, int, error) { return nil, 0, nil }
