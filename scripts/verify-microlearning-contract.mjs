...
contains("apps/portal-web/src/app/microlearning/[slug]/page.tsx",/LearningResource[\s\S]*Editorial Portal[\s\S]*Bukan completion Moodle/,"detail wajib memuat SEO terstruktur dan provenance editorial");
