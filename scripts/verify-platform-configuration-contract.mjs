...
const admin = ["apps/admin-web/src/components/platform-configuration-editor.tsx", "apps/admin-web/src/app/dashboard/platform-configuration/page.tsx"].map(read).join("\n");
