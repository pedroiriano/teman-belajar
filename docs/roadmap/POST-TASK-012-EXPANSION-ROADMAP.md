...
| TASK-015 | Webinar & Live Learning | P1-High | Daftar, detail, jadwal/zona waktu, narasumber, kuota, registrasi, reminder, attendance reference, dan rekaman; Zoom melalui Moodle `mod_zoom` authoritative berdasarkan ADR-020. | TASK-021, recovered `mod_zoom`, Moodle Web Service contract | PROVIDER/POLICY APPROVED — BLOCKED_PREREQUISITES |
