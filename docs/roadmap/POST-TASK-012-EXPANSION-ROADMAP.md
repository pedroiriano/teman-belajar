...
|---|---|---|---|---|---|
| TASK-013 | Pelatihan Penuh / Full Training Programs | P1-High | Katalog program terstruktur, detail, kumpulan course, jadwal, eligibility, CTA enrol/start, dan agregasi progres. Portal mengorkestrasi experience; Moodle memiliki course/enrolment/completion. | TASK-005, TASK-006, TASK-007 | READY FOR MERGE — PR #33 |
